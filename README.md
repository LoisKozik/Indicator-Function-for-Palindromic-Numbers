...
$$D_1(n) = \left\lfloor \frac{1}{\left\lfloor \log(n)+1 \right\rfloor}  \sum_{k=1}^{\left\lfloor \log(n)+1 \right\rfloor}  \left\lfloor 

\frac{\left\lfloor 10 \bigg (\frac{n}{10^k} - \left\lfloor \frac{n}{10^k} \right\rfloor \bigg) + 1 \right\rfloor
...
$$D_2(n) = \prod_{k=1}^{\left\lfloor \log(n)+1 \right\rfloor}
\left\lfloor 
